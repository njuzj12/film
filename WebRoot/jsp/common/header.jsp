  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="/cineplex/filmaction_home.action">首页 <span class="sr-only">(current)</span></a></li>
        <li><a href="/cineplex/useraction_joinActivity.action">我的活动</a></li>
        <li><a href="/cineplex/useraction_consumeRecord.action">我的消费记录</a></li>
        <li><a href="/cineplex/useraction_rechargeRecord.action">我的充值记录</a></li>
      </ul>
      ...
      <ul id="header_login" class="nav navbar-nav navbar-right" style="display:none">
        <li class="dropdown" >
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="/cineplex/useraction_myAccount.action">我的信息</a></li>
            <li class="divider"></li>
