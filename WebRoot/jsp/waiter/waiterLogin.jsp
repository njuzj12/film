...
<script type="text/javascript">
	function waiterSubmit(){
		$.ajax({  
        	url:"json/ajaxUserAction_waiterLogin.action",  
        	type:"POST",  
        	data: {},
        	dataType:"json",  
        	success:function(data){
        		window.location.href="waiteraction_makePlan.action";
        	}  
    	});
  ...
  <body>
    ...
    <div class="row" style="margin-top:80px">
		<div class="col-md-offset-1 col-md-5">
			<img style="max-width:600px" src="images/common/waiter.jpg"/>
		</div>
		<div class=" col-md-3">
				...
				<button type="button" onclick="waiterSubmit()" class="btn btn-default">登陆</button>
		</div>
	</div>
