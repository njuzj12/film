		...
		<div class="col-md-offset-1 col-md-4">
			<p>
				<a
					...
					href="waiteraction_filmInfo.action?film=${film.filmId}">${film.name}</a>
			</p>
			...
			<table class="table table-bordered">
				...
				<c:forEach var="plan" items="${plans}">
					<tr>
						...
						<td> <a href="waiteraction_chooseSeat.action?planId=${plan.planId }" target="blank" style="background-color: #fff; border: 1px solid #d9d9d9; color: #ff8400;"><span>选座购票</span></a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
