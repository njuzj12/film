...
<script>
	...
	function selectSeat(i,j){
		...
		var discountamount=amount*9/10;
	...
	function chooseSeatSubmit(){
		...
		var price=seatNum*${plan.price}*9/10;
		$.ajax({  
        	url:"json/ajaxFilmAction_waiterPay.action",  
        	type:"POST",  
        	...
        	success:function(data){
        		...
        		if (data.message=="failure"){
        			...
        			alert("购买成功");
        			window.location.href="waiteraction_chooseSeat.action?planId=${plan.planId}";
        		}
        	}  
    	});
    	}
